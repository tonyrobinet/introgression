...
"/Volumes/data/sync/poissons/genetique_poissons/genotypage_bar/resultats/analyses_finales/Fst/21localities/noms_827DLAB_ICESNAME_sreg_xy.csv" %>% read.csv(.,header=T) %>% as_tibble -> noms_827DLAB
...
noms_827ATL_10MED$reg -> geno_827ATL_10MED_1012loci_9reg$pop
...
noms_827ATL_10MED$reg -> geno_827ATL_10MED_960neutral_9reg$pop
...
noms_827DLAB$reg -> geno_827ATL_32outliers_7reg$pop
...
noms_827DLAB$reg -> geno_827ATL_980neutral_7reg$pop
...
noms_827DLAB$reg -> geno_827ATL_1012loci_7reg$pop

#    sur 9 regions (7 ATL et 2 MED): 1012 loci
...
#    sur 9 regions (7 ATL et 2 MED): 52 outliers ATL-MED
x=pvalues=mat.obs=mat.perm=NPERM=allTests=NULL
...
#    sur 9 regions (7 ATL et 2 MED): 960 neutres ATL-MED
x=pvalues=mat.obs=mat.perm=NPERM=allTests=NULL
...
#    sur 7 regions ATL: 32 outliers intra-ATL
x=pvalues=mat.obs=mat.perm=NPERM=allTests=NULL
...
#    sur 7 regions ATL: 980 neutres intra-ATL
x=pvalues=mat.obs=mat.perm=NPERM=allTests=NULL
